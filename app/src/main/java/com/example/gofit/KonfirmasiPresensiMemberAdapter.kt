...
class KonfirmasiPresensiMemberAdapter (private var historys: List<HistoriBookingKelasMember>, context: Context): RecyclerView.Adapter<KonfirmasiPresensiMemberAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: KonfirmasiPresensiMemberAdapter.ViewHolder, position: Int) {
        ...
        holder.tvTanggalBook.text = "ID Member: ${data.TANGGAL_HARIAN}"
        holder.tvTanggalMelakukan.text = "Nama Member: ${data.TANGGAL_YANG_DIBOOKING_KELAS}"
