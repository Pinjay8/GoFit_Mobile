...
class HomeInstrukturFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.cardpresensi.setOnClickListener{
            val intent = Intent(activity, JadwalInstrukturPresensiActivity::class.java)
            startActivity(intent)
        }

        binding.btnInstruktur.setOnClickListener {
            val intent = Intent(activity, AktivitasInstrukturActivity::class.java)
            startActivity(intent)
        }
    }
